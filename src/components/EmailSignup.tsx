  ...
  if (submitted) {
    return (
      <div className="glass-card rounded-3xl p-6 text-center">
        ...
        <p className="text-xs text-muted-foreground mt-1">정식 출시 시 상세 분석지와 1개월 무료 이용권을 보내드립니다.</p>
      </div>
    );
  }
    ...
    <div className="glass-card rounded-3xl p-6">
      <div className="text-center mb-4">
        ...
        <p className="text-xs text-muted-foreground mt-1.5 leading-relaxed">
          입력하신 메일로 오늘의 상세 분석지와 함께 정식 버전 출시 시 <strong>'1개월 무료 이용권'</strong>을 보내드립니다.
        </p>
      </div>
      <div className="flex gap-2">
        ...
        >
          {loading ? '...' : <>알림 신청 <ArrowRight className="w-3.5 h-3.5" /></>}
        </button>
      </div>
    </div>
  );
